...
- [ ] 1. Widen `upsertUser` role + add instructor/student credential seeders
...
- [ ] 2. Add `seedVictimResponses()` deterministic, idempotent fixture seeder
...
- [ ] 3. Add 4 unauthenticated (anon) RPC cases
...
- [ ] 4. Add 4 cross-org RPC isolation cases + seed responses in beforeAll
...
- [ ] 5. Create the instructor self-scope + positive-control + streak-edge spec
...
- [ ] 6. Validate the suite (static gate, then red-team run)
...
- [ ] 7. (post-commit) Update + verify the attack-surface matrix
