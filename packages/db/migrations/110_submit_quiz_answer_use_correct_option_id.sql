-- Migration 110: submit_quiz_answer reads the MC answer key from questions.correct_option_id
...
-- correctness-derivation swap. Depends on 20260612000100 (correct_option_id column).
