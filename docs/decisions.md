...
## 92 — 2026-09-24 — Gate reviewer briefs carry the branch, range, round, PR number and the inputs the reviewer's definition requires; never a prior finding, a fix to verify or a focus area. #1360
