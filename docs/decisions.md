...
## 89 — 2026-09-24 — Before review, CI tries to fetch the head copy of every non-deleted file GitHub returns without a patch, and the reviewer's verdict names any changed file it could not review. #1355
