...
SETTLED in Decision 63, which settles two more it never recorded. Still open: several
...
## Decision 63: five policy contradictions settled; `.claude/**` joins the lint (2026-09-07)
