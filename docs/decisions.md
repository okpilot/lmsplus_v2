...
## 89 — 2026-09-24 — The CI reviewer receives the head copy of every file GitHub returns without a patch, and its verdict names any changed file it could not review.
