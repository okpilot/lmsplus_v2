...
## 78 — 2026-09-22 — An opus CI reviewer workflow submits one review per PR head commit — REQUEST_CHANGES on any CRITICAL/ISSUE finding, else COMMENT, never APPROVE; only a new commit or a human dismissal lifts a block. #1338
