...
**Decided:**
- Create red-team suite: Playwright attack specs executing exploit chains against local Supabase (same as production); 48 specs as of 2026-06-25 covering OWASP A01/A02/A03/A07/A09 and A10:2025 (exceptional-condition handling / error-path information disclosure)
...
### Decision 48: dnd-kit for drag-and-drop question types (`ordering`, `diagram_label`) (2026-06-25)
