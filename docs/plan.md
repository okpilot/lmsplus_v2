...
- **Phase 4** (this PR): promoted the learnings to binding rules — code-style.md §5 (column-existence + cast-guard-applies-to-tests) and §7 (HARD new-query-site integration-test policy + non-vacuous integration-assertion rule) + Decision 46.
