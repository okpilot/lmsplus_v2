...
**Integration tests:** 6 new tests in `rpc-has-image-pool.integration.test.ts` (all/only/exclude pool membership, count==quiz, DEFAULT 'all', only+unseen composition). Suite now 160 (post-#837 suite 154 + 6 new).
