...
describe('SessionCard', () => {
  ...
  it('renders correct/answered-item counts, not correct/total-question counts', () => {
    render(
      <SessionCard
        session={makeSession({ correctCount: 7, totalQuestions: 10, answeredItems: 12 })}
      />,
    )
  ...
  it('renders an em dash for the correct count when nothing was answered', () => {
    render(<SessionCard session={makeSession({ correctCount: 0, answeredItems: 0 })} />)
