 ...
 * Returns the policy-applying handlers (`handleSubjectChange`,
 * `handleFiltersChange`, `handleCalcModeChange`, `handleImageModeChange`) alongside
 * the raw setters it still exposes directly (`setMode`, `setCount`).
 */
