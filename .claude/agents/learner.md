...
- Transition row states (`WATCHING → RULE CANDIDATE → PROMOTED/RESOLVED/RESOLVED-WATCH/FALSE POSITIVE`, and `RULE CANDIDATE` or `PROMOTED` → `SATURATED`); never delete a row.
