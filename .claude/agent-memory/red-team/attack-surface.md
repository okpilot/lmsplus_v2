...
|----|--------|----------|-----------|--------|-------|
| A | submit_quiz_answer accepts foreign questionId | HIGH | rpc-question-membership.spec.ts | FAILING (gap confirmed) | No question-subject membership check in RPC |
...
| F | Student INSERT into audit_events | MEDIUM | audit-event-forgery.spec.ts | FAILING (gap confirmed) | Students may forge audit events |
