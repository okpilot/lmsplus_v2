...
| `run-mutations.mjs` grades from HEAD — uncommitted test additions make new mutations SURVIVE vacuously (the harness runs the OLD suite against the mutation). Fix: commit tests before grading, or verify manually in a scratch worktree with the test file copied in. | 2026-09-22 | 1 | 2026-09-22 | WATCHING |
