...
|---|---|---|---|---|
| New error path / branch in a modified file left untested (modified file already has a co-located test) | 2026-03-13 | 14 | 2026-07-11 | PROMOTED → enforced: write the branch test in the SAME commit |
