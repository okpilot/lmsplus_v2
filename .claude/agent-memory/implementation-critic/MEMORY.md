...
| Doc **or code comment** describes DB guard behavior that doesn't match the migration body | 2026-06-06 | 4 | 2026-08-09 | PROMOTED → code-style.md §10 (#1162, #1152). Applies to CODE COMMENTS and to RLS POLICY migrations, not only function bodies. †
