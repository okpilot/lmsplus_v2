...
| Commit message misattributes an overclaim to a PRIOR commit; it lived only in THIS commit's own draft. Detail → [durable-catches](topics/durable-catches.md#2026-09-08-relocated-rows) | 2026-09-08 (8867ccea) | 2 | 2026-09-14 (9a79ec78) | WATCHING — grep the PRIOR commit for the phrase first. Instance 2: ab310cc9's message described a tech.md deferral as its own change; tech.md is absent from ab310cc9's file stat. The parent ff562c9f made a change but it was an extension, not a deferral. |
