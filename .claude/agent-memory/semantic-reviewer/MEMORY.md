...
| Comment names a rule/symbol a LATER commit retired — a PARTIAL edit is the tell. Detail → [prose-guards](topics/prose-guards-and-migration-numbering.md) | 2026-08-15 | 22 | 2026-09-02 (clean) | RULE CANDIDATE → **PROMOTE**: grep tree-wide, re-verify by diff |
