...
| Unmeasured numeric claim in commit prose, never grep'd, wrong every time. Detail → [durable-catches](topics/durable-catches.md#2026-09-08-relocated-rows) | 2026-09-06 (`2e4cf2a3`) | 4 | 2026-09-15 (`6d0fa76a`) | RULE CANDIDATE — `grep -c` before writing a number |
