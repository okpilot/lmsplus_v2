---
name: durable-review-checks
description: Stable per-domain plan-review checklists (SQL, pagination, extraction, UI, red-team, validation, agent-tooling)
metadata:
  type: feedback
---

> Moved from MEMORY.md main body 2026-07-08 to keep index under cap.
> DO NOT prune or rename this file — it is a stable reference topic.
...
## Return-type contract for discriminated-union additions
