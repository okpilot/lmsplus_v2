...
- [Corpus-codification programme (2026-09-17–09-20)](topics/corpus-codification-milestones.md) — mutation encoding, GROUP markers, spawn helpers, measurement scripts.
...
Recent audits (2026-09-14 through 2026-09-20): Decision 66/73/74/78 calibration and documentation, commit-msg gate mirrors, false-positive lists, memory-only binding audits, test-count inventory checks, waiver-residue references, section-name drift, CR-local round-membership + retirement, mutation-encoding premise and gap progression, GROUP marker linking, baseline-policy mirrors, mutation claim deletion, Lefthook pre-commit false-claim sweep. See git log for detail.
