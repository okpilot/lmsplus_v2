...
Recent audits (2026-09-14 through 2026-09-17): Decision 66 calibration claims, commit-msg gate mirrors, false-positive lists, memory-only binding audits, test-count inventory checks, waiver-residue references, and section-name drift. See git log for detail. Current audit: `chore/record-mechanical-lever` (spec-only, round 1) — research findings recorded in corpus-codification spec; no mirroring to binding docs required.
