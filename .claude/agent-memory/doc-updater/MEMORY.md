...
Recent audits (2026-09-14 through 2026-09-17): Decision 66 calibration claims, commit-msg gate mirrors, false-positive lists, memory-only binding audits, test-count inventory checks, waiver-residue references, and section-name drift. See git log for detail. Current audit: branch `chore/pre-push-review-gate` (round 1 of #1298) — CLAUDE.md/lefthook.yml/agent-*.md sections renamed; Decision 73 measurements live in-comment; steering-doc mirror accuracy on pre-push loop mechanics.
