...
Recent audits (2026-09-14 through 2026-09-17): Decision 66 calibration claims, commit-msg gate mirrors, false-positive lists, memory-only binding audits, test-count inventory checks, waiver-residue references, section-name drift, and Decision 74 round-membership (2026-09-17, chore/record-mechanical-lever). See git log for detail.
