...
| Fix commit correcting §10 violations introduces fresh §10 | 31 | 2026-09-08 | RULE CANDIDATE (31 — per-branch unit). 6TH BRANCH `chore/evidence-gate` (`4ec5b894`..`d728e389`, `check-commit-claims.mjs`) — 10 same-branch instances, most caught PRE-commit across 5 impl-critic rounds, not across separate commits; the branch's own final message: "Four of them are mine." Text exists (§10 cl.3), enforcement gap. STAYS OPEN — full mapping + dominant-pattern + mechanical-checkability answer in cross-agent-lessons.md §"Branch chore/evidence-gate" |
