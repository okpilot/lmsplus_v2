...
| Pre-existing file-size violation surfaced when commit adds lines to over-limit file | 10 | 2026-06-27 | PROMOTED → code-style.md §1 (same-commit-extraction, promoted at count=8). 10th: Discovery-rework dd493371 — plan-critic 2 ISSUEs (quiz-session.tsx 158>150 + quiz-config-form.tsx 150 at cap) + orchestrator caught 3rd pre-existing (use-quiz-state.ts 89>80); all same-commit-extracted. [full → topics/tracker-archive.md] |
