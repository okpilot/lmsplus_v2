...
| Stale local master corrupts ALL master...HEAD analyses (security-path floor, PR sweep, CR-local scope) | 2 | 2026-07-23 | RULE CANDIDATE → add pre-session fast-forward check to agent-workflow.md. [full → archive] |
