...
| Integration-test count in plan.md goes stale on each test-adding commit | 3 | 2026-06-10 | RULE CANDIDATE (count 3) — (1) 115→121; (2) 121→125; (3) 125→127. Update plan.md count in the same commit as the test files. … [full → topics/tracker-archive.md] |
