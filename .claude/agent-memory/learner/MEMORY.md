...
Full record in `topics/tracker-archive.md`; journal in git at `2e87c3e6`. Schema: `Issue Type | Count | Last Seen | Status`. Terminal-state rows archived; active rows are terse stubs. Recent curations: 2026-06-20 (#925 Phase 3 — CLAUDE.md QA-pipeline drift count=1→2 RULE CANDIDATE; 2 new WATCHING; 1 FALSE POSITIVE; budget pass), 2026-06-21 (#925 Phase 4 — vacuous-assertion PROMOTED → code-style.md §7; stale-hash-in-durable-files new count=1 WATCHING; archive row 417 reconciled PROMOTED), 2026-06-21 (#918 — 2 new count=1 WATCHING: .single() bare-access FP pattern; practice-mode session cleanup distinction), 2026-06-21 (#931 — results-array-length WATCHING count=1→2 RULE CANDIDATE; 1 new WATCHING: mode-specific anti-cheat branch in lifecycle tests). Earlier curation history in git.
