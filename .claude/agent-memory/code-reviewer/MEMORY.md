...
| Utility function > 30 lines | 2026-05-31 (c879a259) | 15 | 2026-07-13 (eec31df2) | WATCHING. Active over-30L: getSessionReports 64L; buildReportQuestions 65L; getQuizReportQuestions 160L; startOralExam 44L (fix: extract validateMode); getOralExamSession 31L (fix: extract toResponses helper); buildHandleSubmit 47L; buildFinishDialogHandlers 37L; assembleQuizState 36L; useOrderingInput 46L; useFinishQuizDialog 59L; useResumeExamActions 61L (new eec31df2 — fix: extract to resume-exam-handlers.ts builder module, mirror exam-start-handlers.ts pattern). QuizReportView RESOLVED 5ac5ae17. Seed helpers structural exceptions. Pre-existing worsened: handleSave in quiz-recovery-handlers.ts ~35L→41L (not newly flagged). |
