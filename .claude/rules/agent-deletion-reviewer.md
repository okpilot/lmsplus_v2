...
> Model: sonnet | Trigger: pre-push review gate — every round | Blocking: on ISSUE
...
## Handling Results
### DO
- Run in every round of every pre-push gate, in the same parallel batch, on the branch diff.
