...
Plan-critic review — ONE run (skip for single-file < 10 lines)
    ...
    └─► a CRITICAL the orchestrator cannot resolve ─► STOP, hand off to the user
        (§ "One run, not rounds" below; § NEVER forbids executing with one open)
    │
    ▼
