...
- **Existing-implementation parity and callers:** new code whose paging, caps, error handling or fallback differs from the repo's existing code for the same operation, and callers of changed exported code, are ISSUEs.
