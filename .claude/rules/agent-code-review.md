...
- Never steer it (`agent-workflow.md § Gate reviewer agent integration`): the prompt carries the dispatch mechanics above, the round and the PR number once one exists — never a prior finding, a fix to verify or a focus area.
