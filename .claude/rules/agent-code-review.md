...
- Never steer it (`agent-workflow.md § Gate reviewer agent integration`): the prompt carries the dispatch mechanics above and the PR number only — never a prior finding, a fix to verify or a focus area.
