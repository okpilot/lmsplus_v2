-- Randomize answer option order in get_quiz_questions RPC.
-- Previously options were sorted deterministically by ID, meaning students
-- always saw A/B/C/D in the same positions. Now each call returns options
-- in a random order, preventing positional memorisation.
