-- Migration 140: get_report_answer_keys reveals the `ordering` canonical sequence
...
-- match the per-slot blank_index the grader stores (mig 138). DISTINCT ON dedupes
