-- Migration 143: questions.ordering_items column + question_type widening for the
...
-- get_quiz_questions (mig 145) delivers the items SHUFFLED to hide it.
--
...
-- (mig 145) and the ordering grader (mig 147) use `id` as the stable key and `text` as
