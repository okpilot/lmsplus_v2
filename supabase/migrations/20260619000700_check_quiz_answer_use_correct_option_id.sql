-- Migration 117: check_quiz_answer reads the MC answer key from
-- questions.correct_option_id (#823, P0 security). Companion to mig
-- 20260619000100, which relocated the key out of options[].correct and strips
...
-- match its sibling submit_quiz_answer (mig 112) — this RPC returns the answer
...
-- migrations in this series: batch_submit_quiz 112b, report RPCs 114/115).
