-- Migration 138: _grade_record_ordering — internal per-slot grade+record helper
...
--
-- The dispatcher (batch_submit_quiz, mig 139) fans out one entry per sequence
...
-- through the SAME machinery as dialog_fill (Decision 49 / spec N7 deviation).
--
