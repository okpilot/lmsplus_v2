-- 024_batch_submit_reject_discarded.sql
-- Fix: reject batch_submit_quiz calls on discarded (soft-deleted) sessions.
-- Without this, a student who discards a session could still complete it via the RPC.
