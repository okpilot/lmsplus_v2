-- Migration 113: get_vfr_rt_exam_results reads the MC answer key from
-- questions.correct_option_id (#823, P0 security). Companion to mig 20260612000100, which
...
-- Depends on 20260612000100 (correct_option_id column).
